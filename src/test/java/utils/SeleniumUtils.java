...
public class SeleniumUtils {
    ...
    public static void setText(WebElement webElement, WebDriverWait wait, String text){
        wait.until(ExpectedConditions.visibilityOfAllElements(webElement));
        webElement.clear();
        webElement.sendKeys(text);
    }

    public static void selectByValue(WebElement webElement, String value, WebDriverWait wait){
        wait.until(ExpectedConditions.visibilityOfAllElements(webElement));
        Select select = new Select(webElement);
        select.selectByValue(value);
    }

    public static void selectByText(WebElement webElement, String text, WebDriverWait wait){
        wait.until(ExpectedConditions.visibilityOfAllElements(webElement));
        Select select = new Select(webElement);
